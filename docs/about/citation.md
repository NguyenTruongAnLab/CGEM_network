...
## Citing C-GEM Network

If you use C-GEM Network in your research, please cite:
...
### C-RIVE Biogeochemistry

For the biogeochemistry module:
...
### Savenije's Estuarine Theory

For hydrodynamics and salinity intrusion:
...
```bibtex
@article{vandenburgh1972dispersion,
...
C-GEM Network development has been supported by:

- [xxxxxx institutions]

The biogeochemistry module is based on C-RIVE, developed by the METIS team (Sorbonne Université, CNRS).
