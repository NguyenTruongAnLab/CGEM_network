#!/usr/bin/env python3
"""
Setup Mekong Delta - SIMPLIFIED Nguyen-Savenije Configuration
=============================================================
...
=========
    ...
    [Vam Nao]═══(3)═══════════(4)═══[Vam Nao]
       Tien       │      7 km      │      Hau
                  │  PRISMATIC     │
            Tien_Lower (50 km)   Hau_Lower (90 km)
                  │                │
        ┌─────────┼─────────┐      │
        │         │         │      │
    My_Tho   Ham_Luong  Co_Chien   │
     70km     75km      85km       │
      ...
      (6)       (7)       (8)    (9)
      Sea       Sea       Sea    Sea
     N→S:    North → Central → South → Far South
...
- Node 5: My Thuan split (3-way junction)
- Node 4: Vam Nao Hau junction doubles as Hau entry
...
# ===========================================================================
# SIMPLIFIED TOPOLOGY (9 Nodes, 7 Branches)
# ===========================================================================
...
NODES = {
    ...
    5: {"name": "My_Thuan", "type": "JUNCTION", "desc": "My Thuan - Tien splits to 3 distributaries"},
...
BRANCHES = [
    ...
    # =========================================================================
    # TIEN LOWER: Vam Nao → My Thuan split (Group 1)
    # =========================================================================
    
    # 4. Tien Lower: Continues from Vam Nao junction to My Thuan
    #    50 km reach before distributary split
    ...
    # 5. My Tho: My Thuan (5) → Sea (6) - NORTHERNMOST
    #    Merged: Cua Tieu + Cua Dai
    #    70 km, strong convergence, shallower (11m)
    (5, "My_Tho", 5, 6, 70000, 900, 2200, 11.0, 60, 2, 1.2),
    
    # 6. Ham Luong: My Thuan (5) → Sea (7) - CENTRAL
    #    75 km, moderate convergence, deeper (12m)
    (6, "Ham_Luong", 5, 7, 75000, 1000, 2500, 12.0, 60, 2, 1.2),
    
    # 7. Co Chien: My Thuan (5) → Sea (8) - SOUTHERNMOST TIEN
    #    Merged: Cung Hau + Co Chien
    #    85 km, strong convergence, deepest Tien (13m)
    (7, "Co_Chien", 5, 8, 85000, 1100, 2800, 13.0, 60, 2, 1.2),
    
    # =========================================================================
    # HAU DISTRIBUTARY (Group 2: Single merged branch)
    # =========================================================================
    
    # 8. Hau River: Vam Nao Hau (4) → Sea (9) - FAR SOUTH
    #    Merged: Dinh An + Tran De
    #    90 km long reach from Vam Nao to sea, deep (14m)
    (8, "Hau_River", 4, 9, 90000, 1200, 3000, 14.0, 58, 2, 1.3),
]
...
def generate_topology_csv() -> str:
    """Generate topology.csv with simplified Nguyen-Savenije structure."""
    lines = [
        "# ============================================================================",
        "# TOPOLOGY: Mekong Delta (Nguyen-Savenije Simplified)",
        "# ============================================================================",
...
def generate_case_config() -> str:
    ...
    return f"""# ============================================================================
# C-GEM Network: Mekong Delta (Nguyen-Savenije Simplified)
# ============================================================================
# Simplified topology following Nguyen et al. (2006):
# - 8 branches, 9 nodes
...
def main():
    ...
    print(f"   ✓ {len(BRANCHES)} branches, 9 nodes")
    ...
    print("\n" + "=" * 70)
    print("SIMPLIFIED NETWORK TOPOLOGY (Nguyen-Savenije)")
    print("=" * 70)
    print("""
                    [Tan Chau]              [Chau Doc]
                       (1)                     (2)
    ...
    [Vam Nao Jct] ════(3)════ Vam_Nao ════(4)════
       Tien side       │      7 km PRISMATIC    │
                ...
                [My Thuan]                      │
                  ...
                  / │ \\                         │
                /   │   \\                       │
           My_Tho Ham_L Co_Chien                │
            70km  75km   85km                   │
              │     │      │                    │
            (6)   (7)    (8)                  (9)
           [Sea]  [Sea]  [Sea]               [Sea]
            ↑      ↑      ↑                    ↑
          NORTH  CENTER SOUTH              FAR SOUTH
